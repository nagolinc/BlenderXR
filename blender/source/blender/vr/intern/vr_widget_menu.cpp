...
void Widget_Menu::click(VR_UI::Cursor &c)
{
  ...
  switch (tool->type()) {
    ...
    case TYPE_TEXTUREPAINT: {
      menu_type[c.side] = MENUTYPE_TS_TEXTUREPAINT;
      break;
    }
    case TYPE_SCULPT: {
...
void Widget_Menu::drag_start(VR_UI::Cursor &c)
{
  ...
  int index_to_highlight = Widget_Menu::get_highlight_index(angle[c.side], num_items[c.side]);
...
void Widget_Menu::drag_stop(VR_UI::Cursor &c)
{
  ...
  int index_to_highlight = Widget_Menu::get_highlight_index(angle2, num_items[c.side]);
  if (stick[c.side].x < 0) {
  ...
  switch (menu_type[c.side]) {
    ...
    case MENUTYPE_TS_TRANSFORM: {
      if (angle2 >= 0 && angle2 < PI) {
        ...
        if ((VR_UI::ui_type == VR_DEVICE_TYPE_VIVE) || (VR_UI::ui_type == VR_DEVICE_TYPE_PIMAX) ||
            (VR_UI::ui_type == VR_DEVICE_TYPE_MAGICLEAP)) {
          /* Duplicate */
    ...
    case MENUTYPE_SWITCHTOOL: {
      ...
      /* TexturePaint */
      else if (index_to_highlight == 12) {
        VR_UI::set_current_tool(&Widget_TexturePaint::obj, c.side);
        Widget_SwitchTool::obj.curr_tool[c.side] = &Widget_TexturePaint::obj;
        Widget_TexturePaint::cursor_side = c.side;
        for (int i = 0; i < VR_SIDES; ++i) {
...
void Widget_Menu::render_icon(const Mat44f &t, VR_Side controller_side, bool active, bool touched)
{
  ...
  if (action_settings[controller_side]) {
    switch (type) {
      ...
      case MENUTYPE_AS_TRANSFORM: {
        /* Center */
        const bool center_use_stick = (VR_UI::ui_type == VR_DEVICE_TYPE_OCULUS) ||
                                      (VR_UI::ui_type == VR_DEVICE_TYPE_INDEX);
        VR_Layout::ButtonBit btnbit = center_use_stick ? VR_Layout::BUTTONBITS_STICKS :
                                                         VR_Layout::BUTTONBITS_DPADS;
        ...
        if (VR_UI::ui_type == VR_DEVICE_TYPE_WINDOWSMR) {
          ...
          *((Coord3Df *)t_icon.m[3]) =
              VR_Layout::button_positions[vr_get_obj()->device_type][controller_side]
                                         [VR_Layout::BUTTONID_DPAD];
        ...
        if (VR_UI::ui_type == VR_DEVICE_TYPE_WINDOWSMR) {
          ...
          *((Coord3Df *)t_icon.m[3]) =
          ...
          if (Widget_Sculpt::mode_orig == BRUSH_STROKE_INVERT) {
            ...
            VR_Draw::render_rect(
                -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::plus_tex);
          }
          t_icon.m[1][1] = t_icon.m[2][2] = 1;
          t_icon.m[1][2] = t_icon.m[2][1] = 0;
        }
      ...
      case MENUTYPE_AS_ANIMATION: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.004f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::x_str_tex);
        if (Widget_Animation::constraint_flag[1][0]) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.004f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::z_str_tex);
        if (Widget_Animation::constraint_flag[1][2]) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 6) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.004f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::y_str_tex);
        if (Widget_Animation::constraint_flag[0][1]) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
    ...
    switch (menu_type[controller_side]) {
      ...
      case MENUTYPE_TS_ANNOTATE: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_10;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.005f, -0.005f, 0.001f, 1.0f, 1.0f, VR_Draw::box_empty_tex);
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_stick;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::box_filled_tex);
        break;
#else
        return;
#endif
        ...
        if (VR_UI::ui_type == VR_DEVICE_TYPE_MAGICLEAP) {
          ...
          *((Coord3Df *)t_icon.m[3]) = p8_0;
          ...
          switch (Widget_Transform::transform_space) {
            case VR_UI::TRANSFORMSPACE_NORMAL: {
              VR_Draw::render_rect(
                  -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_normal_tex);
              break;
            }
            case VR_UI::TRANSFORMSPACE_LOCAL: {
              VR_Draw::render_rect(
                  -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_local_tex);
              break;
            }
            case VR_UI::TRANSFORMSPACE_GLOBAL:
            default: {
              VR_Draw::render_rect(
                  -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_global_tex);
              break;
            }
          }
          if (menu_highlight_index == 0) {
          ...
          *((Coord3Df *)t_icon.m[3]) = p8_2;
          ...
          VR_Draw::update_modelview_matrix(&m, 0);
          VR_Draw::render_rect(
              -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::redo_tex);
          if (menu_highlight_index == 2) {
            VR_Draw::set_color(c_menu_white);
          }
          /* index = 6 */
          ...
          *((Coord3Df *)t_icon.m[3]) = p8_1;
          ...
          VR_Draw::update_modelview_matrix(&m, 0);
          VR_Draw::render_rect(
              -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::undo_tex);
          if (menu_highlight_index == 1) {
            VR_Draw::set_color(c_menu_white);
          }
          /* index = 3 */
      ...
      case MENUTYPE_TS_SCULPT: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::background_menu_tex);
        // if (menu_highlight_index == 0) {
        VR_Draw::set_color(c_menu_white);
        //}
        /* index = 4 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_grab_tex);
        if (menu_highlight_index == 4) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 2 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_mask_tex);
        if (menu_highlight_index == 2) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 6 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_6;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_Sculpt::dyntopo ? VR_Draw::box_filled_tex :
                                                      VR_Draw::box_empty_tex);
        if (Widget_Sculpt::dyntopo) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_5;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_Sculpt::raycast ? VR_Draw::box_filled_tex :
                                                      VR_Draw::box_empty_tex);
        if (Widget_Sculpt::raycast) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_draw_tex);
        if (menu_highlight_index == 1) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 3 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_smooth_tex);
        if (menu_highlight_index == 3) {
          VR_Draw::set_color(c_menu_white);
        }
        /* Center */
      ...
      case MENUTYPE_TS_SCULPT_DRAW: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_claystrips_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_CLAY_STRIPS) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_inflate_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_INFLATE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_crease_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_CREASE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 6) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_5;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_blob_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_BLOB) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 5) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_layer_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_LAYER) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_clay_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_CLAY) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
      ...
      case MENUTYPE_TS_SCULPT_SMOOTH: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_fill_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_FILL) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_pinch_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_PINCH) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_scrape_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_SCRAPE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_flatten_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_FLATTEN) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
      ...
      case MENUTYPE_TS_SCULPT_GRAB: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_thumb_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_THUMB) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_rotate_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_ROTATE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_nudge_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_NUDGE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_snakehook_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_SNAKE_HOOK) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
      ...
      case MENUTYPE_TS_SCULPT_OTHER: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_simplify_tex);
        if (Widget_Sculpt::brush == SCULPT_TOOL_SIMPLIFY) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
      ...
      case MENUTYPE_TS_SCULPT_STRENGTH: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        m = t_icon * t;
        VR_Draw::update_modelview_matrix(&m, 0);
        // VR_Draw::render_string("0.5", 0.009f, 0.012f, VR_HALIGN_CENTER, VR_VALIGN_TOP, 0.0f,
        // 0.005f, 0.001f);
        /* index = 4 */
        /* index = 2 */
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::plus_tex);
        // VR_Draw::render_string("1", 0.009f, 0.012f, VR_HALIGN_CENTER, VR_VALIGN_TOP, 0.0f,
        // 0.005f, 0.001f);
        /* index = 6 */
        if (menu_highlight_index == 6) {
          VR_Draw::set_color(c_menu_blue);
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::reset_tex);
        // VR_Draw::render_string("1", 0.009f, 0.012f, VR_HALIGN_CENTER, VR_VALIGN_TOP, 0.0f,
        // 0.005f, 0.001f);
        if (menu_highlight_index == 6) {
          VR_Draw::set_color(c_menu_white);
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_5;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_Sculpt::use_trigger_pressure ? VR_Draw::box_filled_tex :
                                                                   VR_Draw::box_empty_tex);
        if (Widget_Sculpt::use_trigger_pressure) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::minus_tex);
        // VR_Draw::render_string("0", 0.009f, 0.012f, VR_HALIGN_CENTER, VR_VALIGN_TOP, 0.0f,
        // 0.005f, 0.001f);
        /* index = 3 */
        /* Center */
        *((Coord3Df *)t_icon.m[3]) = p8_stick;
      ...
      case MENUTYPE_TS_ANIMATION: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        /* index = 2 */
        bool bindtype_controller_right = (Widget_Animation::bind_type ==
                                          Widget_Animation::BINDTYPE_CONTROLLER_RIGHT);
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             bindtype_controller_right ? VR_Draw::box_filled_tex :
                                                         VR_Draw::box_empty_tex);
        if (bindtype_controller_right) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        /* index = 5 */
        /* index = 1 */
        bool bindtype_controller_left = (Widget_Animation::bind_type ==
                                         Widget_Animation::BINDTYPE_CONTROLLER_LEFT);
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             bindtype_controller_left ? VR_Draw::box_filled_tex :
                                                        VR_Draw::box_empty_tex);
        if (bindtype_controller_left) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        /* index = 3 */
        bool bindtype_tracker = (Widget_Animation::bind_type ==
                                 Widget_Animation::BINDTYPE_TRACKER);
        if (bindtype_tracker) {
          VR_Draw::set_color(c_menu_red);
        }
        else if (menu_highlight_index == 3) {
      ...
      case MENUTYPE_SWITCHTOOL: {
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(0, n_items);
        if (menu_highlight_index == 0) {
          menu_str = "TRANSFORM";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(1, n_items);
        if (menu_highlight_index == 1) {
          menu_str = "ANNOTATE";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(2, n_items);
        if (menu_highlight_index == 2) {
          menu_str = "MEASURE";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(3, n_items);
        if (menu_highlight_index == 3) {
          menu_str = "EXTRUDE";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(4, n_items);
        if (menu_highlight_index == 4) {
          menu_str = "BEVEL";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(5, n_items);
        if (menu_highlight_index == 5) {
          menu_str = "KNIFE";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(6, n_items);
        if (menu_highlight_index == 6) {
          menu_str = "SCULPT";
          m = m_widget_touched * t_icon * t;
        }
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::sculpt_tex);
        if (type == TYPE_SCULPT) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 6) {
        ...
        *((Coord3Df*)t_icon.m[3]) = Widget_Menu::calculated_coord(6,n_items) ;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(-0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f,
        VR_Draw::animation_tex); if (type == TYPE_ANIMATION) { VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 6) {
          VR_Draw::set_color(c_menu_white);
        }*/
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(7, n_items);
        if (menu_highlight_index == 7) {
          menu_str = "LOOP CUT";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(8, n_items);
        if (menu_highlight_index == 8) {
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(9, n_items);
        if (menu_highlight_index == 9) {
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(10, n_items);
        if (menu_highlight_index == 10) {
          menu_str = "SELECT";
          m = m_widget_touched * t_icon * t;
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(11, n_items);
        ...
        /* index = 12
        TEXTUREPAINT */
        if (type == TYPE_TEXTUREPAINT) {
          VR_Draw::set_color(c_menu_green);
        }
        else if (menu_highlight_index == 12) {
          VR_Draw::set_color(c_menu_blue);
        }
        *((Coord3Df *)t_icon.m[3]) = Widget_Menu::calculated_coord(12, n_items);
        if (menu_highlight_index == 12) {
          menu_str = "TEXTUREPAINT";
          m = m_widget_touched * t_icon * t;
        }
        else {
          m = t_icon * t;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::texturepaint_tex);
        if (type == TYPE_TEXTUREPAINT) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 12) {
      ...
      case MENUTYPE_MAIN_12: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_8;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::separate_tex);
        if (menu_highlight_index == 8) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 10 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_10;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::select_tex);
        if (menu_highlight_index == 10) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 11 (exit region) */
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_9;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::objectmode_tex);
        if (menu_highlight_index == 9) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 7 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_7;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::join_tex);
        if (menu_highlight_index == 7) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 1 */
...
Coord3Df Widget_Menu::calculated_coord(int index, int n)
{
  Coord3Df out(0.06 * sin(((float)index) / ((float)n) * 2 * PI),
               0.06 * cos((float)index / (float)n * 2 * PI),
               0.0f);
  return out;
}

int Widget_Menu::get_highlight_index(float angle2, int n)
{
